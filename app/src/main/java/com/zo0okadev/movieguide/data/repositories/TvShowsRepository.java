...
import com.zo0okadev.movieguide.data.dataSourceFactories.TvShowsOnTheAirDatasourceFactory;
...
public class TvShowsRepository {
    ...
    public LiveData<PagedList<ListTvShow>> getTvShowsOnTheAir() {
        TvShowsOnTheAirDatasourceFactory tvShowsOnTheAirDatasourceFactory = new TvShowsOnTheAirDatasourceFactory();
        PagedList.Config config = new PagedList.Config.Builder()
                .setEnablePlaceholders(true)
                .setInitialLoadSizeHint(20)
                .setMaxSize(60)
                ...
                .setPrefetchDistance(20)
                .build();
        return new LivePagedListBuilder<>(tvShowsOnTheAirDatasourceFactory, config).build();
    }
