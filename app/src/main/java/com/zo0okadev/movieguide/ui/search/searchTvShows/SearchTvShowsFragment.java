package com.zo0okadev.movieguide.ui.search.searchTvShows;
...
public class SearchTvShowsFragment extends Fragment {
    ...
    public static SearchTvShowsFragment newInstance() {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(SearchTvShowsViewModel.class);
