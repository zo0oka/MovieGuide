...
public class ListTvShow {
    ...
    public static final DiffUtil.ItemCallback<ListTvShow> DIFF_CALLBACK = new DiffUtil.ItemCallback<ListTvShow>() {
        @Override
        public boolean areItemsTheSame(@NonNull ListTvShow oldItem, @NonNull ListTvShow newItem) {
            return newItem.getId().equals(oldItem.getId());
        }

        @Override
        public boolean areContentsTheSame(@NonNull ListTvShow oldItem, @NonNull ListTvShow newItem) {
