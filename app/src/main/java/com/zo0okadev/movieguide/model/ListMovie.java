...
public class ListMovie {
    ...
    public static final DiffUtil.ItemCallback<ListMovie> DIFF_CALLBACK = new DiffUtil.ItemCallback<ListMovie>() {
        @Override
        public boolean areItemsTheSame(@NonNull ListMovie oldItem, @NonNull ListMovie newItem) {
            return oldItem.getId().equals(newItem.getId());
        }

        @Override
        public boolean areContentsTheSame(@NonNull ListMovie oldItem, @NonNull ListMovie newItem) {
